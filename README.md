...
Cleaned and processed 2,900+ records of WHO data using Python (Pandas, NumPy)

Performed univariate, bivariate, and multivariate analysis using Seaborn, Matplotlib, and Plotly

Visualized correlations between GDP, schooling, alcohol use, BMI, and life expectancy

Compared trends between Developed vs. Developing countries

Built a simple linear regression to predict life expectancy
